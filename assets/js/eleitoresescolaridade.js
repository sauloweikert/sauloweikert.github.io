function fazGraficoEleitoresEscolaridade(opcao){
  ...
  d3.csv("dados/"+arquivoASerLido, function(d, i, columns) {
    ...
    x0.domain(data.map(function(d) { return d.escolaridade; }));
    ...
    g.append("g")
      ...
      .data(data)
      .enter().append("g")
        .attr("transform", function(d) { return "translate(" + x0(d.escolaridade) + ",0)"; })
      .selectAll("rect")
  ...
  d3.select("g")
  	...
  	.style("font-size", 15)
  	.attr("text-width","bold")
  	.text("Quantidade de eleitores por escolaridade");

  var ok = funcaoGerarDados("numeroEleitoresAlf5.csv");
  ...
  d3.select(".div-grafico")
  	.append("text")
  	.text("Ordene em ordem de nível de escolaridade")
  	...
  	.on("click", function(){
  		...
  		funcaoGerarDados("numeroEleitoresAlf5.csv");
  	});
  ...
  d3.select(".div-grafico")
  	...
  	.on("click", function(){
  		...
  		d3.selectAll("#itemLegendaTexto").remove();
  		d3.selectAll("#tentativa").remove();
  		funcaoGerarDados("numeroEleitoresCresc5.csv");
  	});
  ...
  d3.select(".div-grafico")
  	...
  	.on("click", function(){
  		...
  		d3.selectAll("#itemLegendaTexto").remove();
  		d3.selectAll("#tentativa").remove();
  		funcaoGerarDados("numeroEleitoresDecr5.csv");
  	});
}
